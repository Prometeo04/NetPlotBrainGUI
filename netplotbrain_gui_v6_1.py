...
# CRÍTICO: configurar backend ANTES de importar netplotbrain
# Sin esto, en PCs con gráficos integrados el plot se genera invisible
import matplotlib
...
STYLES = ["surface", "cloudy", "filled", "glass"]  # glass al final: requiere GPU dedicada
...
class NetPlotBrainApp:
    ...
    def _build_ui(self):
        ...
        # Template style
        self.style_var = tk.StringVar(value="surface")
